...
// Serial.println(String(filtered_roll)+','+String(filtered_pitch)+','+String(accelX*10)+','+String(accelY*10)+','+String(accelZ*10));
//Serial.println("AccleX:"+String(accelX*10)+" ,AccleY:"+String(accelY*10)+" ,AccleZ"+String(accelZ*10)+" ,GyroX(roll)"+String(filtered_roll)+" ,GyroY(pitch)"+String(filtered_pitch));
//delay(3000);
Serial.println(String(accelX*10)+','+String(accelY*10));
    }
